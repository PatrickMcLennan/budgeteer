export const WEEKDAYSnumber = new Map<number, string>();
WEEKDAYSnumber.set(0, 'Sunday');
WEEKDAYSnumber.set(1, 'Monday');
WEEKDAYSnumber.set(2, 'Tuesday');
WEEKDAYSnumber.set(3, 'Wednesday');
WEEKDAYSnumber.set(4, 'Thursday');
...
MONTHSnumber.set(2, 'March');
MONTHSnumber.set(3, 'April');
MONTHSnumber.set(4, 'May');
MONTHSnumber.set(5, 'June');
MONTHSnumber.set(6, 'July');
MONTHSnumber.set(7, 'August');
MONTHSnumber.set(8, 'September');
MONTHSnumber.set(9, 'October');
...
MONTHSstring.set('March', 2);
MONTHSstring.set('April', 3);
MONTHSstring.set('May', 4);
MONTHSstring.set('June', 5);
MONTHSstring.set('July', 6);
MONTHSstring.set('August', 7);
MONTHSstring.set('September', 8);
